...
2. Fetch chaque URL d'offre
3. Vérifie le contenu de la page (offre expirée, date, bouton postuler)
4. Met à jour le champ validation_status
5. Génère data/offres_lba_validated.json
...
def main():
    ...
    # 3. Filtrer les offres validées uniquement
    validated_offers = [o for o in offers if o.get('validation_status') == 'validated']

    # 4. Mettre à jour les meta
    ...
    # 5. Sauvegarder le JSON validé (seulement les offres validées)
    ...
    print(f"💀 Expirées/Invalides: {expired_count}")
